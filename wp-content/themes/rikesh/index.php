...
?>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_bg_4.jpg)" data-stellar-background-ratio="0.5">
	...
	<div class="flex-section gtco-gray-bg">
		...
		<div class="col-2 flex-img" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_1.jpg);"></div>
	</div>
	
	<div class="gtco-cover gtco-cover-sm" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_bg_2.jpg)"  data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
	...
	<div class="flex-section reverse">
		...
		<div class="col-2 flex-img" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_bg_2.jpg);"></div>
	</div>

	<div class="gtco-cover gtco-cover-sm" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_bg_3.jpg)" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="gtco-container text-center">
			<div class="display-t">
				<div class="display-tc">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<a href="#" class="gtco-card-item">
							<figure>
								...
								<img src="<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_1.jpg" alt="Image" class="img-responsive">
							</figure>
							<div class="gtco-text">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<a href="#" class="gtco-card-item">
							<figure>
								<div class="overlay"><i class="ti-plus"></i></div>
								<img src="<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_2.jpg" alt="Image" class="img-responsive">
							</figure>
							<div class="gtco-text">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<a href="#" class="gtco-card-item">
							<figure>
								<div class="overlay"><i class="ti-plus"></i></div>
								<img src="<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_3.jpg" alt="Image" class="img-responsive">
							</figure>
							<div class="gtco-text">
								<h2>Branding</h2>
								<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
	...
	<div class="gtco-cover gtco-cover-sm" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_bg_1.jpg)"  data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="gtco-container text-center">
			<div class="display-t">
				<div class="display-tc">
