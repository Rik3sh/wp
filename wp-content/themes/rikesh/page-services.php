<?php get_header(); ?>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(<?php echo get_site_url(); ?>/wp-content/themes/rikesh/images/img_bg_4.jpg)" data-stellar-background-ratio="0.5">
